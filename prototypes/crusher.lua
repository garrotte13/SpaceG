...
--]]
...

    {
      ...
      animation =
      {
          ...
          {
            {
              filename = "__SpaceG__/graphics/crusher_apm/crusher_0.png",
              priority = "high",
              width = 160,
              height = 128,
              frame_count = 32,
              ...
              hr_version =
              {
                filename = "__SpaceG__/graphics/crusher_apm/hr_crusher_0.png",
                priority = "high",
                width = 320,
                height = 256,
                frame_count = 32,
          ...
          
            {
                ...
                hr_version =
                {
                  filename = "__SpaceG__/graphics/crusher_apm/hr_crusher_shadow.png",
                  priority = "high",
                  draw_as_shadow = true,
                  width = 320,
                  height = 256,
